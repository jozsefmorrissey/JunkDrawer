 ...
 * Creates a scenario in which only one move can keep the king out of check.
 */
public class Continuing extends StandardPosition{
    ...
    public void setRooks(Board board){
        ...
        Piece rook3 = new Rook(new Tuple(5,1), board);
