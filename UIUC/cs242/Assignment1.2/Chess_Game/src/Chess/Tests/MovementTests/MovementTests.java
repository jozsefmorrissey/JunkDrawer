...
import Chess.Pieces.StandardChessPieces.King;
import Chess.Pieces.Piece;
import Chess.Pieces.StandardChessPieces.Queen;
import Chess.StartingPosition.StartingPosition;
import Chess.Tests.TestingScenarios.Castling;

import java.util.Vector;

/**
 * Created by jozsef on 2/4/16.
 * Verifies the movement of the queen witch utilizes nearly all the movement calculating functions.
 * Also verifies the castling movements of the king.
 */
