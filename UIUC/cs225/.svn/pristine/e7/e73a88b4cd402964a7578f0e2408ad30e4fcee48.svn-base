...
namespace filler {
    ...
    /*template <template <class T> class OrderingStructure>
    void order(PNG & img, int x, int y, OrderingStructure<class T> & myOs);

    template<template<class T> class OrderingStructure>
    animation assembler(PNG & img, colorPicker & fillColor, int xCenter, int yCenter, int x, int y,  int tolerance, OrderingStructure<class T> myOs, int counter, int frameFreq, animation anim);
    */
}
#include "filler.cpp"
#endif
