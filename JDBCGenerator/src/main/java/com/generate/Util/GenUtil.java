...
{
	public static void buildAndSave(String pckg, TypeSpec.Builder typeInfBuilder) throws IOException
	{
		JavaFile javaInfFile = JavaFile.builder(pckg, typeInfBuilder.build())
			    .build();
				
		javaInfFile.writeTo(new File("src/main/java/"));
	}
	...
	public static List<String> parseColumns(Node tag, String tagName)
	{
	...
	public static TypeName getResultType() {
		return ParameterizedTypeName.get(List.class, Map.class);
	}
